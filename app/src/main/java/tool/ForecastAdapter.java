...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            day_icon = (ImageView) itemView.findViewById(R.id.day_icon);
            night_icon = (ImageView) itemView.findViewById(R.id.night_icon);
            text = (TextView) itemView.findViewById(R.id.info_text_forecast);
            maxDegree = (TextView) itemView.findViewById(R.id.max_text_forecast);
            minDegree = (TextView) itemView.findViewById(R.id.min_text_forecast);
    ...
    public void set(List<Forecast> forecastList) {
        this.forecastList = forecastList;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.date.setText(forecast.fxDate);
        holder.text.setText(forecast.textDay);
        holder.maxDegree.setText(forecast.tempMax);
        holder.minDegree.setText(forecast.tempMin);
